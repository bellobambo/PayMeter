...
export default function ConsoleFeaturesPage() {
  const { features, createFeature, updateFeature, toggleFeature } = useConsoleData();
  ...
  return (
    <>
      <ConsoleHeader
        description="Keep feature creation and pricing separate from analytics so founders can make changes with less cognitive noise."
      ...
      <section className="mt-6 grid gap-6 xl:grid-cols-[0.82fr_1.18fr]">
        <div className="rounded-lg border border-ink/10 bg-white p-5 shadow-line">
          <div className="flex items-start justify-between gap-4">
            <div>
              <h2 className="text-xl font-semibold text-ink">New feature</h2>
              <p className="mt-2 text-sm leading-6 text-graphite">
                A feature is anything a customer should pay for before the app performs it.
              </p>
            </div>
          ...
          <form className="mt-6 space-y-4" onSubmit={handleCreateFeature}>
            ...
            <button
              ...
              disabled={isCreating}
            >
              {isCreating ? "Creating feature..." : "Create feature"}
                  ...
                  <div>
                    {isEditing ? (
                      ...
                      <>
                        ...
                        <p className="mt-2 text-sm text-graphite">{compactNumber(feature.usageCount)} checks processed</p>
                      </>
                    )}
                  </div>
